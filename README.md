...
16. random rotation 코드 추가 **[Commit No.16]**    
- import random, random.sample(range(0, 6), 1) 코드를 통해 난수 생성  
- random 숫자를 배열 => 정수형태로 변환  
- x또는 X를 입력시 => 미리 생성해둔 배열[U L F R B D] 중, 임의의 인덱스 값을 입력    
- 정상작동확인  
